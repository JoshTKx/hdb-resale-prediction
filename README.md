...
2. **Run Notebooks in Order**
   - Start with `HDB_resale_analysis.ipynb` for data exploration
   - Continue with `HDB_resale_preprocessing.ipynb` for feature engineering
   - Finish with `HDB_resale_model.ipynb` for model training
